...
> **Important**: All shadcn/ui components must be added to this package, rather than directly in individual apps. This ensures consistency across the monorepo and prevents duplication of UI code.
