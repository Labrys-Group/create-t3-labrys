...
Our documentation is split between markdown files and in-code JSDoc:

### Required in Markdown Files:
...
### 1. Feature Documentation (in Markdown)
...
### 3. Data Models Documentation (in Markdown)
...
Documentation should be stored co-located with the code it documents:
...
1. All new features must include markdown documentation
2. All modified features must have updated markdown documentation
3. All new or modified Typegoose models must be documented in markdown
...
7. All configuration changes including new environment variables must be documented in markdown

## Documentation Review Checklist

Reviewers should ensure documentation:

- [ ] Is in the correct location (markdown files or JSDoc)
