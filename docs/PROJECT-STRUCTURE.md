...
- **Apps**: The main applications (Next.js, Expo). This is where you would put a new application (eg. admin dashboard).
...
> **Note**: The `apps/expo` folder can be safely deleted if you are not using Expo in your project. It is included to demonstrate how to set up multiple apps within the same monorepo.

See app-specific documentation:
- [Next.js App Documentation](../apps/nextjs/docs/README.md)
- [Expo App Documentation](../apps/expo/docs/README.md)
